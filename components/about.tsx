  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        ...
        К каждому заказу я подхожу с большой ответственностью и любовью, так как хочу заявить о себе,
        исключаю плагиат и небрежность, полностью изучаю проект, заказчика и его целевую аудиторию, работаю на качество, стараюсь сделать заказ максимально быстро и уникально, учитывая все правки и пожелания.
        Доверившись мне, вы получите максимальную отдачу от вашего проекта, сэкономите свои нервы и время.
        Если я вас заинтересовал, и вы хотите узнать что-то больше или воспользоваться моими услугами, то ниже я укажу все свои контакты.
        <br />
        Frontend-разработка постоянно меняется и развивается.
        Я постоянно обновляю свои знания и навыки, учусь новым технологиям и следую последним трендам в отрасли, чтобы быть в курсе и предоставлять самые передовые решения.
      </p>
